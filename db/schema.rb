...
ActiveRecord::Schema.define(version: 20131218140517) do
  ...
  create_table "education_programs", force: true do |t|
    ...
    t.integer  "educationLevel_id"
  end

  create_table "examination_in_education_programs", force: true do |t|
    t.integer  "discipline_id"
    t.integer  "examinationType_id"
